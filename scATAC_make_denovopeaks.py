...
samfile = open("SRR1947693_MQ_dedup_noM.sorted.sam","r")
barcodefile = open("../GSM1647123_GM12878vsHL.indexconversion.txt","r")
newsamfile = open("SRR1947693_MQ_barcodes_dedup_500.sorted.sam","w")
...
for line in barcodefile.readlines():
    line = line.split()
    barcodes["SRR1947693." + line[0]] = line[2]
    cellcount[line[2]] = 0
barcodefile.close()
...
samfile = pysam.AlignmentFile("SRR1947693_MQ_barcodes_dedup_noM_500_header.sorted.bam", "rb")
peaks = open("SRR1947693_peaks.bed","r")
...
df.to_csv("PeakMatrix_SRR1947693.csv")
