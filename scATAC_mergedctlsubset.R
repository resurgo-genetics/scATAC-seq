...
DHSmatrix = fread('CtlSetMerged.dhsmatrix.rowreduced_fixed.csv',header=F,stringsAsFactors = F,sep ="\t")
...
#write to a file
write.table(DHSmatrix,"CtlSetMerged.dhsmatrix.GMfullyreduced.csv")

#get bed file for coordinates
DHSmatrix1 = fread('CtlSetMerged.dhsmatrix.rowreduced_fixed.csv',header=F,stringsAsFactors = F,sep ="\t",skip=1)
